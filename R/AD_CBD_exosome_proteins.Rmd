...
merged_top <- replace(merged_top, is.na(merged_top), 0) # Some functions do not allow NA.
...
# Use grey in color palette to indicate values that were NA.
color <- colorRampPalette(rev(brewer.pal(n = 7, name = "RdYlBu")))(100)
color[50] <- "#DDDDDD"

# Generate heatmap, setting breaks to use grey in color palette appropriately.
