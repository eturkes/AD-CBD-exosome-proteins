...
plot_numbers(data) +
  ...
  scale_x_discrete(labels = sub("\\.", " ", paste(data$condition, data$donor, sep = " ")))
plot_frequency(data)
plot_detect(data)
...
mat <- assay(data)
colnames(mat) <- sub("\\.", " ", paste(data$condition, data$donor, sep = " "))
rownames(experimental_design) <- sub("\\.", " ", paste(data$condition, data$donor, sep = " "))
