...
MNAR_cutoff <- 12
cat(paste0("We set the cutoff at ", MNAR_cutoff))
# --------------------------------------------------------------------------------------------------
```
...
data <- data[F1_order, ]
F1_MNAR <- names(
  which(rowMeans(assay(data)[ , which(data$condition == "Fraction.1")], TRUE) < MNAR_cutoff)
)
...
data <- data[F2_order, ]
F2_MNAR <- names(
  which(rowMeans(assay(data)[ , which(data$condition == "Fraction.2")], TRUE) < MNAR_cutoff)
)
...
data <- data[F3_order, ]
F3_MNAR <- names(
  which(rowMeans(assay(data)[ , which(data$condition == "Fraction.3")], TRUE) < MNAR_cutoff)
)
...
data <- data[F4_order, ]
F4_MNAR <- names(
  which(rowMeans(assay(data)[ , which(data$condition == "Fraction.4")], TRUE) < MNAR_cutoff)
)
...
data <- data[F5_order, ]
F5_MNAR <- names(
  which(rowMeans(assay(data)[ , which(data$condition == "Fraction.5")], TRUE) < MNAR_cutoff)
)
...
data <- data[F6_order, ]
F6_MNAR <- names(
  which(rowMeans(assay(data)[ , which(data$condition == "Fraction.6")], TRUE) < MNAR_cutoff)
)
...
data <- data[F7_order, ]
F7_MNAR <- names(
  which(rowMeans(assay(data)[ , which(data$condition == "Fraction.7")], TRUE) < MNAR_cutoff)
)
...
data <- data[F8_order, ]
F8_MNAR <- names(
  which(rowMeans(assay(data)[ , which(data$condition == "Fraction.8")], TRUE) < MNAR_cutoff)
)
...
F2_data <- data[ , which(data$condition == "Fraction.1")]
...
F3_data <- data[ , which(data$condition == "Fraction.1")]
...
F4_data <- data[ , which(data$condition == "Fraction.1")]
...
F5_data <- data[ , which(data$condition == "Fraction.1")]
...
F6_data <- data[ , which(data$condition == "Fraction.1")]
...
F7_data <- data[ , which(data$condition == "Fraction.1")]
...
F8_data <- data[ , which(data$condition == "Fraction.1")]
...
```{r}
plot_pca(data, n = dim(data)[1], indicate = "condition", label = TRUE) +
...
```{r}
plot_pca(
  complete_cases, n = dim(complete_cases)[1], indicate = "condition", label = TRUE
) +
