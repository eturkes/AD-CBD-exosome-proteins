...
cache_dir <- file.path("..", "tmp", "cache", data_name, "peptides")
...
```{r}
data <- read.delim(file.path(assets_dir, data_name, "20220404_DOB_AllPatients_v1.pr_matrix.tsv"))
tmp1 <- data[ , 1:10]
...
![](../tmp/cache/oxford-ms-data-april-2022/peptides/NormalyzerDE/pngs/10_boxplot.png)
![](../tmp/cache/oxford-ms-data-april-2022/peptides/NormalyzerDE/pngs/11_rel_log_expr.png)
