...
packages <- c(
  ...
  "ComplexHeatmap", "volcano3D", "GSEABase", "GSVA", "RColorBrewer", "limma", "tibble", "readxl",
  "khroma", "biomaRt", "NormalyzerDE"
)
...
```{r}
data <- read.delim(file.path(assets_dir, "oxford-ms-data-april-2022", "20220404_DOB_AllPatients_v1.pg_matrix.tsv"))
tmp1 <- data[ , 1:5]
...
data2 <- read_xlsx(
  file.path(assets_dir, "oxford-ms-data-april-2022", "20220405_MSQ2321_StephanieFowler_DOB_EV64.xlsx")
)
...
```{r, fig.height = 25, fig.width = 15, dev = "svglite"}
...
```{r, fig.height = 5, fig.width = 15, dev = "svglite"}
order <- c(
...
```{r, fig.height = 3, fig.width = 15, dev = "svglite"}
order <- c(
  "heterophilic cell-cell adhesion via plasma membrane cell adhesion molecules",
  "proteoglycan binding",
  "anchored component of external side of plasma membrane",
