...
VSN_Normalized_Unimputed_Data <- normalize_vsn(unimputed_data)
...
print("VSN_Normalized_Unimputed_Data")
meanSdPlot(VSN_Normalized_Unimputed_Data)
...
plot_normalization(Log_Transform_Only, VSN_Normalized) +
  ...
  scale_x_discrete(labels = data$nice_names)
plot_normalization(Log_Transform_Only_Unimputed_Data, VSN_Normalized_Unimputed_Data) +
  theme(axis.text.y = element_text(size = 3)) +
  scale_x_discrete(labels = data$nice_names)
...
unimputed_data <- VSN_Normalized_Unimputed_Data
complete_cases <- VSN_Normalized_Non_Missing_Data
rm(
  VSN_Normalized, VSN_Normalized_Unimputed_Data, VSN_Normalized_Non_Missing_Data,
