...
packages <- c(
  ...
  "biomaRt", "NormalyzerDE", "stringi", "readxl"
)
...
MISEV <- read_excel(file.path(assets_dir, "fractions", "MISEV-master-list_Aug 24_2023.xlsx"))
...
proteins <- proteins[-which(is.na(proteins))]
...
colnames(sub_data) <- data$nice_names
