...
### Each Cell-type Sorted by Abundance (Adjusted P-value Cutoff = 0)
...
### Most Abundant Markers (Adjusted P-value Cutoff = 0)
...
### Each Cell-type Sorted by Abundance (Adjusted P-value Cutoff = 0 & log2FC > 1)

```{r, fig.width = 15}
markers <- read.delim(file.path(assets_dir, "gene-sets", "markers.tsv"))
markers <- markers[markers$p_val_adj == 0 & markers$avg_log2FC > 1, ]
markers <- markers %>% distinct(gene, .keep_all = TRUE)
markers_orig <- markers
...
### Most Abundant Markers (Adjusted P-value Cutoff = 0 & log2FC > 1)
...
### Each Cell-type Sorted by Abundance (Adjusted P-value Cutoff = 0 & log2FC > 2)

```{r, fig.width = 15}
markers <- read.delim(file.path(assets_dir, "gene-sets", "markers.tsv"))
markers <- markers[markers$p_val_adj == 0 & markers$avg_log2FC > 2, ]
markers <- markers %>% distinct(gene, .keep_all = TRUE)
markers_orig <- markers
...
### Each Cell-type Sorted by Abundance (Adjusted P-value Cutoff = 0 & log2FC > 5)

```{r, fig.width = 15}
markers <- read.delim(file.path(assets_dir, "gene-sets", "markers.tsv"))
markers <- markers[markers$p_val_adj == 0 & markers$avg_log2FC > 5, ]
markers <- markers %>% distinct(gene, .keep_all = TRUE)
markers_orig <- markers
...
### Most Abundant Markers (Adjusted P-value Cutoff = 0 & log2FC > 5)
