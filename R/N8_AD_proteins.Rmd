...
proteins <- c(markers$gene[1:15], markers$gene[(nrow(markers) - 14):nrow(markers)])
proteins_cell_type <- c(
  paste(markers$cluster[1:15], markers$gene[1:15], sep = "_"),
  paste(
    markers$cluster[(nrow(markers) - 14):nrow(markers)],
    markers$gene[(nrow(markers) - 14):nrow(markers)], sep = "_"
  )
)
