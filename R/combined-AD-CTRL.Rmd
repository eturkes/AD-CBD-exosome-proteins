...
packages <- c(
  "RColorBrewer", "dplyr", "DEP", "SummarizedExperiment", "scales", "ggplot2",
...
design$bio_rep <- c(
  "AD_1", "AD_2", "AD_3", "AD_4", "AD_4", "AD_4", "AD_5", "AD_5", "AD_5",
  "CTRL_1", "CTRL_2", "CTRL_2", "CTRL_2", "CTRL_3", "CTRL_4", "CTRL_4", "CTRL_4"
)
# --------------------------------
...
top_anno <- HeatmapAnnotation(
  biological_replicates = design$bio_rep,
  sex = design$sex,
  month_of_run = design$month,
  col = list(
    biological_replicates = c(
      "AD_1" = bio_rep_color[1], "AD_2" = bio_rep_color[2], "AD_3" = bio_rep_color[3],
      "AD_4" = bio_rep_color[4], "AD_5" = bio_rep_color[5], "CTRL_1" = bio_rep_color[6],
      "CTRL_2" = bio_rep_color[7], "CTRL_3" = bio_rep_color[8], "CTRL_4" = bio_rep_color[9]
    ),
    sex = c("M" = sex_color[1], "F" = sex_color[2]),
    month_of_run = c("March" = month_color[1], "Jan" = month_color[2])
  ),
  annotation_legend_param = list(
    biological_replicates = list(title_position = "lefttop-rot"),
    sex = list(title_position = "lefttop-rot"),
    month_of_run = list(title_position = "lefttop-rot")
  )
)
# ------------------------
...
Heatmap(
  assay(heatmap_data),
  colorRampPalette(rev(brewer.pal(11, "RdYlBu")))(round(diff(range(assay(data))))),
