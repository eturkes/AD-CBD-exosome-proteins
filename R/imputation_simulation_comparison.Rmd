...
for (name in names(venn_list)) {
  ...
  if (name == "complete") {
    ...
    keep <- intersect(venn_list$imputed, venn_list$unimputed)[
      intersect(venn_list$imputed, venn_list$unimputed) %notin% venn_list$complete
    ]
    set.seed(10000)
