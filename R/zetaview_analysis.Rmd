...
# ----------------------
data_norm[ , -1] <- (data_norm[ , -1] / max(data_norm[ , -1])) * 100
# ----------------------
...
ggplot(molten_data, aes(Size, relative_proportion, color = Sample)) +
  ...
  scale_x_continuous(breaks = seq(0, max(molten_data$Size), 20)) +
  scale_y_continuous(
    breaks = seq(0, max(molten_data$relative_proportion), 5),
...
for (i in seq(ncol(stats))) {
  ...
  plot(
    ggplot(molten_data, aes(Size, Frequency, color = Sample)) +
      ...
      theme_light() +
      geom_vline(xintercept = as.numeric(stats[4, i])) +
      geom_vline(xintercept = as.numeric(stats[5, i])) +
      geom_vline(xintercept = as.numeric(stats[6, i])) +
